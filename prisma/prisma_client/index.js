...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/home/saha/Projects/adipose/prisma/prisma_client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "/home/saha/Projects/adipose/prisma/schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": "../../.env",
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        ...
        "value": "postgresql://postgres:bmdU37PtRlXWbeIH@localhost:5432/adipose"
      }
    }
  },
  ...
  "inlineSchemaHash": "6daf8255113d9aa6c4b19db9dfd4c5c52059b5e71bae4f72d33aa470c8a4548a",
  "copyEngine": true
}
...
path.join(process.cwd(), "prisma/prisma_client/libquery_engine-debian-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "prisma/prisma_client/schema.prisma")
