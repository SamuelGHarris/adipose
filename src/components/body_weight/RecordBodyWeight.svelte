...
<form class="bg-base-300 text-base-content flex flex-col rounded-md py-2 px-4 shadow-lg {className}">
	...
	{#if formMode === 'anotherDay'}
		<input transition:slide={{ duration: 100 }}  bind:value={dateTime} class="input input-md mt-2" type="datetime-local" />
	{/if}
